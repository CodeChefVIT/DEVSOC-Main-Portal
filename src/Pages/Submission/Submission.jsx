...
<Grid item xs={8} sm={4}><input {...register("Name", {required:true , maxLength:30})} placeholder="Idea Name" className="Idea-name"/></Grid>
<Grid container spacing={2}/>
...
<div className={"bkg"} style={{
          ...
          }} src={saltysubmission}  alt={"image"} className="From-img"/>
        </div>
            <BottomNav/>
        </div>
    );
